...
model = Sequential()
model.add(Dense(input_dim = 4096, units = 256, activation = 'relu', kernel_regularizer=regularizers.l2(0.01)))
...
plot_train_history(train_history, 'acc', 'val_acc', 'loss', 'val_loss', 'acc4.pdf', 'loss4.pdf')
